...
export default function Labor() {
    ...
    return (
        <>
            <GeneralBanner title="Direito Trabalhista"></GeneralBanner>
            <Container>
